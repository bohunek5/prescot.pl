...
<head>
  ...
  <link rel="stylesheet" href="/prescot-global.css?v=20260901-baza-blog-v6">
  <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js"></script>
  
  <title>Baza Wiedzy & Poradniki LED — Prescot</title>
  <meta name="description" content="Ekspercka baza wiedzy i artykuły poradnikowe o oświetleniu LED: taśmy COB, profile aluminiowe, złączki bez lutowania, dobór zasilacza 24V i eliminacja spadków napięć.">
...
<section class="p-full-hero" style="background-image: url('/wp-content/uploads/2026/03/AdobeStock_1101216226-1536x861.webp');">
  <div class="p-full-hero-content">
    ...
    <p class="lead">Kompendium wiedzy oświetleniowej dla instalatorów, projektantów i dystrybutorów. Poznaj zasady montażu taśm COB, doboru zasilaczy, profili aluminiowych i eliminacji spadków napięć.</p>
    <div class="p-hero-actions">
      <a href="#artykuly-blog" class="p-btn p-btn-primary">
        Przeglądaj Artykuły &amp; Blog
...
<main id="content-start" class="prescot-main-container">
  ...
  <!-- 2. BAZA WIEDZY / BLOG Z ARTYKUŁAMI (3 W RZĘDZIE / 1 NA TELEFONIE) -->
  <section id="artykuly-blog" style="margin-bottom: 70px;">
    <div class="blog-section-header">
      <h2>Poradniki, Artykuły &amp; Wiedza Techniczna</h2>
      <p>Wybierz kategorię tematyczną i dowiedz się, jak prawidłowo dobrać, zamontować i zasilić oświetlenie LED.</p>
    </div>

    <!-- KATEGORIE BLOGA (CHIPS) -->
    <div class="blog-category-filter">
      <button type="button" class="blog-filter-btn active" data-blog-cat="all">Wszystkie artykuły (6)</button>
      ...
      <button type="button" class="blog-filter-btn" data-blog-cat="normy">Normy IP &amp; Strefy Mokre</button>
    </div>

    <!-- BLOG GRID (3 KOLUMNY DESKTOP / 1 TELEFON) -->
    <div class="blog-grid" id="blogGrid">
      
      <!-- ARTYKUŁ 1: Inteligentny Zasilacz -->
      <article class="blog-card" data-cat="zasilacze">
        <div class="blog-thumb-wrap">
          <img src="/wp-content/uploads/2026/03/akceosria-her-3-300x218.webp" alt="Inteligentny Zasilacz LED PRESCOT PR-MAD-1224" class="blog-thumb" loading="lazy">
          <span class="blog-card-tag tag-orange">Nowość 2026</span>
        </div>
        <div class="blog-content">
          ...
          <h3 class="blog-title">Inteligentny Zasilacz LED z auto-detekcją 12V/24V – rewolucja montażowa</h3>
          <p class="blog-excerpt">Jak działa technologia automatycznego rozpoznawania napięcia podłączonej taśmy LED i dlaczego eliminuje ryzyko spalenia instalacji przez pomyłkę instalatora.</p>
          <a href="https://www.prescot.com.pl/pl/n/34" target="_blank" rel="noopener" class="blog-card-link">
            Czytaj artykuł &rarr;
          </a>
        </div>
      </article>

      <!-- ARTYKUŁ 2: Taśmy COB bez kropek -->
      <article class="blog-card" data-cat="tasmy">
        <div class="blog-thumb-wrap">
          <img src="/wp-content/uploads/2026/03/PCB-768x974.webp" alt="Linia światła bez kropek taśmy COB" class="blog-thumb" loading="lazy">
          <span class="blog-card-tag">Technologia COB</span>
        </div>
        <div class="blog-content">
          <div class="blog-meta">
            <span class="blog-meta-item">
          ...
          <h3 class="blog-title">Jednolita linia światła bez widocznych kropek – jak dobrać taśmę COB?</h3>
          <p class="blog-excerpt">Porównanie gęstości 320 vs 528 LED/m. Zobacz, jak uzyskać gładką wstęgę świetlną w płytkich profilach meblowych i sufitowych bez efektu koralików.</p>
          <a href="https://www.prescot.com.pl/pl/n/23" target="_blank" rel="noopener" class="blog-card-link">
            Czytaj artykuł &rarr;
          </a>
        </div>
      </article>

      <!-- ARTYKUŁ 3: Stopnie IP w strefach mokrych -->
      <article class="blog-card" data-cat="normy">
        <div class="blog-thumb-wrap">
          <img src="/wp-content/uploads/2026/03/AdobeStock_1392520552-1024x574.webp" alt="Oświetlenie stref mokrych i stopnie IP" class="blog-thumb" loading="lazy">
          <span class="blog-card-tag">Bezpieczeństwo IP</span>
        </div>
        <div class="blog-content">
          <div class="blog-meta">
            <span class="blog-meta-item">
            ...
            <span>•</span>
            <span>Normy &amp; Strefy</span>
          </div>
          <h3 class="blog-title">Oświetlenie stref mokrych: łazienki, baseny i elewacje (IP20 vs IP65 vs IP68)</h3>
          <p class="blog-excerpt">Jak zgodnie ze sztuką zasilić i uszczelnić taśmy LED pod prysznicem, w fugach płytek i na tarasie. Przewodnik po powłokach silikonowych i żelowych.</p>
          <a href="https://www.prescot.com.pl/pl/n/33" target="_blank" rel="noopener" class="blog-card-link">
            Czytaj artykuł &rarr;
          </a>
        </div>
      </article>

      <!-- ARTYKUŁ 4: Złączki bez lutowania -->
      <article class="blog-card" data-cat="zlaczki">
        <div class="blog-thumb-wrap">
          <img src="/wp-content/uploads/2026/03/profil-zlaczka-zapalona-768x974.webp" alt="Złączki zaciskowe Prescot MX2045" class="blog-thumb" loading="lazy">
          <span class="blog-card-tag tag-orange">Montaż</span>
        </div>
        <div class="blog-content">
          <div class="blog-meta">
            <span class="blog-meta-item">
          ...
          <h3 class="blog-title">Szybkozłączki do taśm LED – jak łączyć taśmy bez lutownicy na budowie?</h3>
          <p class="blog-excerpt">Praktyczny test złączek zaciskowych MX2045 (8mm) i MN20 (10mm). Szybki montaż narożników 90°, połączeń prostych i przewodów zasilających.</p>
          <a href="https://www.prescot.com.pl/pl/c/Akcesoria-do-zasilaczy-i-tasm-LED/344" target="_blank" rel="noopener" class="blog-card-link">
            Czytaj poradnik &rarr;
          </a>
        </div>
      </article>

      <!-- ARTYKUŁ 5: Profile Aluminiowe jako Radiator -->
      <article class="blog-card" data-cat="profile">
        <div class="blog-thumb-wrap">
          <img src="/wp-content/uploads/2026/03/AdobeStock_958838417-1024x574.webp" alt="Profile aluminiowe LED montaż i chłodzenie" class="blog-thumb" loading="lazy">
          <span class="blog-card-tag">Profile LED</span>
        </div>
        <div class="blog-content">
          <div class="blog-meta">
            <span class="blog-meta-item">
            ...
            <span>•</span>
            <span>Profile &amp; Klosze</span>
          </div>
          <h3 class="blog-title">Dlaczego taśma LED musi być w profilu aluminiowym? Rola chłodzenia</h3>
          <p class="blog-excerpt">Wpływ temperatury na degradację luminoforu. Jak dobrać profil nawierzchniowy, wpuszczany lub bezramkowy do sufitów podwieszanych G-K.</p>
          <a href="https://www.prescot.com.pl/pl/n/12" target="_blank" rel="noopener" class="blog-card-link">
            Czytaj artykuł &rarr;
          </a>
        </div>
      </article>

      <!-- ARTYKUŁ 6: Dobór Zasilacza i Spadki Napięć -->
      <article class="blog-card" data-cat="zasilacze">
        <div class="blog-thumb-wrap">
          <img src="/wp-content/uploads/2026/03/wooden-stairs-with-light-strips-in-a-modern-interi-2025-12-30-20-24-06-utc-300x200.webp" alt="Dobór zasilacza LED i spadki napięcia" class="blog-thumb" loading="lazy">
          <span class="blog-card-tag">Poradnik B2B</span>
        </div>
        <div class="blog-content">
          <div class="blog-meta">
            <span class="blog-meta-item">
            ...
            <span>•</span>
            <span>Zasilanie 24V</span>
          </div>
          <h3 class="blog-title">Jak prawidłowo dobrać moc zasilacza LED i zminimalizować spadek napięcia?</h3>
          <p class="blog-excerpt">Wzory na obliczenie zapasu mocy 20%, dobór przekroju żył przewodów (0.75mm² vs 1.50mm²) oraz zasady zasilania obustronnego dla długich linii.</p>
          <a href="https://www.prescot.com.pl/pl/n/28" target="_blank" rel="noopener" class="blog-card-link">
            Czytaj artykuł &rarr;
          </a>
        </div>
      </article>
  ...
  <!-- 3. FAQ ACCORDION SECTION (10 ZWIĘZŁYCH, KONKRETNYCH PYTAŃ) -->
...
<script src="/local-navigation.js?v=20260901-baza-blog-v6" defer></script>
</body>
</html>
"""
...
print("Created ultimate Baza Wiedzy with 3-column Blog Grid, category filter, clean calculator, and concise FAQ.")
